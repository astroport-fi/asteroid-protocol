...
export const AllTypesProps: Record<string, any> = {
  ...
  launchpad: {
    ...
    stages: {
      ...
      order_by: 'launchpad_stage_order_by',
      where: 'launchpad_stage_bool_exp',
    },
  },
  launchpad_bool_exp: {
    _and: 'launchpad_bool_exp',
    _not: 'launchpad_bool_exp',
    _or: 'launchpad_bool_exp',
    collection: 'collection_bool_exp',
    collection_id: 'Int_comparison_exp',
    date_created: 'timestamp_comparison_exp',
    finish_date: 'timestamp_comparison_exp',
    id: 'Int_comparison_exp',
    max_supply: 'numeric_comparison_exp',
    mint_reservations: 'launchpad_mint_reservation_bool_exp',
    mint_reservations_aggregate:
      'launchpad_mint_reservation_aggregate_bool_exp',
    minted_supply: 'numeric_comparison_exp',
    reveal_date: 'timestamp_comparison_exp',
    reveal_immediately: 'Boolean_comparison_exp',
    stages: 'launchpad_stage_bool_exp',
  ...
  launchpad_mint_reservation_aggregate_order_by: {
    ...
    count: 'order_by',
    max: 'launchpad_mint_reservation_max_order_by',
    min: 'launchpad_mint_reservation_min_order_by',
    stddev: 'launchpad_mint_reservation_stddev_order_by',
    stddev_pop: 'launchpad_mint_reservation_stddev_pop_order_by',
    stddev_samp: 'launchpad_mint_reservation_stddev_samp_order_by',
    sum: 'launchpad_mint_reservation_sum_order_by',
    var_pop: 'launchpad_mint_reservation_var_pop_order_by',
    var_samp: 'launchpad_mint_reservation_var_samp_order_by',
    variance: 'launchpad_mint_reservation_variance_order_by',
  },
  ...
  launchpad_mint_reservation_bool_exp: {
    _and: 'launchpad_mint_reservation_bool_exp',
    _not: 'launchpad_mint_reservation_bool_exp',
  ...
  launchpad_order_by: {
    ...
    collection_id: 'order_by',
    date_created: 'order_by',
    finish_date: 'order_by',
    id: 'order_by',
    max_supply: 'order_by',
    mint_reservations_aggregate:
      'launchpad_mint_reservation_aggregate_order_by',
    minted_supply: 'order_by',
    reveal_date: 'order_by',
    reveal_immediately: 'order_by',
    stages_aggregate: 'launchpad_stage_aggregate_order_by',
    start_date: 'order_by',
    transaction: 'transaction_order_by',
    transaction_id: 'order_by',
  },
  launchpad_select_column: 'enum' as const,
  launchpad_stage: {
    reservations: {
      distinct_on: 'launchpad_mint_reservation_select_column',
      order_by: 'launchpad_mint_reservation_order_by',
    ...
    whitelists: {
      ...
      where: 'launchpad_whitelist_bool_exp',
    },
  },
  launchpad_stage_aggregate_order_by: {
    avg: 'launchpad_stage_avg_order_by',
    count: 'order_by',
    max: 'launchpad_stage_max_order_by',
    min: 'launchpad_stage_min_order_by',
    stddev: 'launchpad_stage_stddev_order_by',
    stddev_pop: 'launchpad_stage_stddev_pop_order_by',
    stddev_samp: 'launchpad_stage_stddev_samp_order_by',
    sum: 'launchpad_stage_sum_order_by',
    var_pop: 'launchpad_stage_var_pop_order_by',
    var_samp: 'launchpad_stage_var_samp_order_by',
    variance: 'launchpad_stage_variance_order_by',
  },
  launchpad_stage_avg_order_by: {
    collection_id: 'order_by',
    id: 'order_by',
    launchpad_id: 'order_by',
    per_user_limit: 'order_by',
    price: 'order_by',
  },
  launchpad_stage_bool_exp: {
    _and: 'launchpad_stage_bool_exp',
    _not: 'launchpad_stage_bool_exp',
    _or: 'launchpad_stage_bool_exp',
    collection_id: 'Int_comparison_exp',
    description: 'String_comparison_exp',
    finish_date: 'timestamp_comparison_exp',
    has_whitelist: 'Boolean_comparison_exp',
    id: 'Int_comparison_exp',
    launchpad: 'launchpad_bool_exp',
    launchpad_id: 'Int_comparison_exp',
    name: 'String_comparison_exp',
    ...
    price_curve: 'price_curve_comparison_exp',
  ...
  launchpad_stage_order_by: {
    ...
    price: 'order_by',
    price_curve: 'order_by',
    reservations_aggregate: 'launchpad_mint_reservation_aggregate_order_by',
    start_date: 'order_by',
    whitelists_aggregate: 'launchpad_whitelist_aggregate_order_by',
  },
  launchpad_stage_select_column: 'enum' as const,
  ...
  launchpad_stage_stream_cursor_input: {
    initial_value: 'launchpad_stage_stream_cursor_value_input',
    ordering: 'cursor_ordering',
  },
  ...
  launchpad_stream_cursor_value_input: {
    ...
    finish_date: 'timestamp',
    max_supply: 'numeric',
    minted_supply: 'numeric',
    reveal_date: 'timestamp',
    start_date: 'timestamp',
  },
  launchpad_whitelist_aggregate_order_by: {
    avg: 'launchpad_whitelist_avg_order_by',
    count: 'order_by',
    max: 'launchpad_whitelist_max_order_by',
    min: 'launchpad_whitelist_min_order_by',
    stddev: 'launchpad_whitelist_stddev_order_by',
    stddev_pop: 'launchpad_whitelist_stddev_pop_order_by',
    stddev_samp: 'launchpad_whitelist_stddev_samp_order_by',
    sum: 'launchpad_whitelist_sum_order_by',
    var_pop: 'launchpad_whitelist_var_pop_order_by',
    var_samp: 'launchpad_whitelist_var_samp_order_by',
    variance: 'launchpad_whitelist_variance_order_by',
  },
  ...
  launchpad_whitelist_bool_exp: {
    _and: 'launchpad_whitelist_bool_exp',
    _not: 'launchpad_whitelist_bool_exp',
    _or: 'launchpad_whitelist_bool_exp',
    address: 'String_comparison_exp',
    collection_id: 'Int_comparison_exp',
    id: 'Int_comparison_exp',
    launchpad_id: 'Int_comparison_exp',
  ...
  launchpad_whitelist_select_column: 'enum' as const,
  ...
  launchpad_whitelist_stream_cursor_input: {
    initial_value: 'launchpad_whitelist_stream_cursor_value_input',
    ordering: 'cursor_ordering',
  },
  ...
  minted_out_launches_bool_exp: {
    _and: 'minted_out_launches_bool_exp',
    _not: 'minted_out_launches_bool_exp',
    _or: 'minted_out_launches_bool_exp',
    chain_id: 'String_comparison_exp',
    collection: 'collection_bool_exp',
    collection_id: 'Int_comparison_exp',
    date_created: 'timestamp_comparison_exp',
  ...
  minted_out_launches_select_column: 'enum' as const,
  minted_out_launches_stream_cursor_input: {
    initial_value: 'minted_out_launches_stream_cursor_value_input',
    ordering: 'cursor_ordering',
  },
  ...
  price_curve: `scalar.price_curve` as const,
  ...
  query_root: {
    ...
    launchpad: {
      distinct_on: 'launchpad_select_column',
      order_by: 'launchpad_order_by',
      where: 'launchpad_bool_exp',
    },
    launchpad_by_pk: {},
    launchpad_mint_reservation: {
      distinct_on: 'launchpad_mint_reservation_select_column',
    ...
    minted_out_launches: {
      distinct_on: 'minted_out_launches_select_column',
      order_by: 'minted_out_launches_order_by',
      where: 'minted_out_launches_bool_exp',
    },
    status: {
    ...
    transaction_by_pk: {},
    troll_post: {
      distinct_on: 'troll_post_select_column',
      order_by: 'troll_post_order_by',
      where: 'troll_post_bool_exp',
    },
  ...
  subscription_root: {
    ...
    launchpad_mint_reservation_stream: {
      cursor: 'launchpad_mint_reservation_stream_cursor_input',
      where: 'launchpad_mint_reservation_bool_exp',
    },
    launchpad_stage: {
      distinct_on: 'launchpad_stage_select_column',
    ...
    launchpad_stage_stream: {
      cursor: 'launchpad_stage_stream_cursor_input',
      where: 'launchpad_stage_bool_exp',
    },
    launchpad_stream: {
      cursor: 'launchpad_stream_cursor_input',
      where: 'launchpad_bool_exp',
    },
    launchpad_whitelist: {
      distinct_on: 'launchpad_whitelist_select_column',
    ...
    launchpad_whitelist_stream: {
      cursor: 'launchpad_whitelist_stream_cursor_input',
      where: 'launchpad_whitelist_bool_exp',
    },
    marketplace_cft20_detail: {
      distinct_on: 'marketplace_cft20_detail_select_column',
    ...
    minted_out_launches_stream: {
      cursor: 'minted_out_launches_stream_cursor_input',
      where: 'minted_out_launches_bool_exp',
    },
    status: {
      distinct_on: 'status_select_column',
    ...
    troll_post_by_pk: {},
    troll_post_stream: {
      cursor: 'troll_post_stream_cursor_input',
      where: 'troll_post_bool_exp',
    },
  },
  ...
  token_bool_exp: {
    ...
    pre_mint: 'numeric_comparison_exp',
  ...
  troll_post_aggregate_fields: {
    count: {
      columns: 'troll_post_select_column',
    },
  },
  troll_post_bool_exp: {
    _and: 'troll_post_bool_exp',
    _not: 'troll_post_bool_exp',
    _or: 'troll_post_bool_exp',
    chain_id: 'String_comparison_exp',
    content_hash: 'String_comparison_exp',
    content_path: 'String_comparison_exp',
    content_size_bytes: 'Int_comparison_exp',
  ...
  troll_post_select_column: 'enum' as const,
  troll_post_stream_cursor_input: {
    initial_value: 'troll_post_stream_cursor_value_input',
    ordering: 'cursor_ordering',
  },
...
export const ReturnTypes: Record<string, any> = {
  ...
  launchpad: {
    ...
    id: 'Int',
    max_supply: 'numeric',
    mint_reservations: 'launchpad_mint_reservation',
    mint_reservations_aggregate: 'launchpad_mint_reservation_aggregate',
    minted_supply: 'numeric',
    reveal_date: 'timestamp',
    reveal_immediately: 'Boolean',
    stages: 'launchpad_stage',
    start_date: 'timestamp',
    transaction: 'transaction',
    transaction_id: 'Int',
  },
  ...
  query_root: {
    ...
    launchpad_whitelist: 'launchpad_whitelist',
    launchpad_whitelist_by_pk: 'launchpad_whitelist',
    ...
    minted_out_launches: 'minted_out_launches',
    status: 'status',
    status_by_pk: 'status',
    token: 'token',
    ...
    troll_post: 'troll_post',
    troll_post_aggregate: 'troll_post_aggregate',
    troll_post_by_pk: 'troll_post',
  },
  search_result: {
    content_path: 'String',
    content_size_bytes: 'Int',
  ...
  subscription_root: {
    ...
    launchpad_stage: 'launchpad_stage',
    launchpad_stage_by_pk: 'launchpad_stage',
    launchpad_stage_stream: 'launchpad_stage',
    launchpad_stream: 'launchpad',
    launchpad_whitelist: 'launchpad_whitelist',
    launchpad_whitelist_by_pk: 'launchpad_whitelist',
    launchpad_whitelist_stream: 'launchpad_whitelist',
    marketplace_cft20_detail: 'marketplace_cft20_detail',
    marketplace_cft20_detail_aggregate: 'marketplace_cft20_detail_aggregate',
    marketplace_cft20_detail_by_pk: 'marketplace_cft20_detail',
    ...
    minted_out_launches: 'minted_out_launches',
    minted_out_launches_stream: 'minted_out_launches',
    status: 'status',
    status_by_pk: 'status',
  ...
  troll_post_aggregate: {
    aggregate: 'troll_post_aggregate_fields',
    nodes: 'troll_post',
  },
  troll_post_aggregate_fields: {
    avg: 'troll_post_avg_fields',
    count: 'Int',
    max: 'troll_post_max_fields',
    min: 'troll_post_min_fields',
    stddev: 'troll_post_stddev_fields',
    stddev_pop: 'troll_post_stddev_pop_fields',
    stddev_samp: 'troll_post_stddev_samp_fields',
    sum: 'troll_post_sum_fields',
    var_pop: 'troll_post_var_pop_fields',
    var_samp: 'troll_post_var_samp_fields',
    variance: 'troll_post_variance_fields',
  },
