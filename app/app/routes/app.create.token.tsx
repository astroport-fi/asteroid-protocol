      ...
      <Form onSubmit={onSubmit} className="flex flex-col mt-4">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex flex-1 flex-col mt-4 lg:mt-0 lg:ml-8">
            ...
            <p className="mt-2">
              The CFT-20 Tokens metaprotocol allows you to create, transfer,
              mint, buy and sell fungible tokens. When used in combination with
              the inscriptions metaprotocol, you can inscribe a logo for your
              token on the chain. The maximum size of a logo is currently{' '}
              {maxFileSize / 1000}kb.
            </p>
            <p>
              Learn more in the
            ...
            <div className="mt-4">
              ...
              <p>
                Set a launch date for your token. Any mints before this date
                will be ignored and not counted towards an address&apos; balance
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <p>
                We create a dedicated mint page for your token where you can
                send people
                <br />
